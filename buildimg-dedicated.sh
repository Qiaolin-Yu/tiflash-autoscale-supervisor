...
docker buildx build --file=Dockerfile-dedicated --platform=linux/amd64,linux/arm64 -t 646528577659.dkr.ecr.us-east-2.amazonaws.com/tiflash-autoscale-supervisor:dedicated-$1 .  --push